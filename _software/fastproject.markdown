...
layout: page
title: FastProject
description: Using gene sets to analyze low-dimensional projections of scRNA-seq data.
img: /assets/project_img/fastproject.png
importance: 10
---
...
Please checkout the project on [GitHub](https://github.com/YosefLab/FastProject).


<img src="/assets/project_img/fastprojectbanner.png" alt="Banner" width="800"/>

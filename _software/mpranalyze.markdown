...
layout: page
title: MPRAnalyze
description: Statistical framework for data generated by MPRAs
img: /assets/project_img/mpranalyze.png
importance: 3
---
...
Please checkout the project on [GitHub](https://github.com/YosefLab/MPRAnalyze) or on [Bioconductor](https://bioconductor.org/packages/release/bioc/html/MPRAnalyze.html).

...
<div id = "{{person.name | replace: ' ', '-'}}" class="row" style="padding-top: 60px; margin-top: -60px; padding-left: 10px">
    <img class="img-fluid" style="float: left; width: auto; padding-left: 20px; padding-right: 20px; min-width: 150px; max-width: 200px; max-height: 200px" src="{{ person.image | prepend: '/assets/people_img/' | prepend: site.baseurl | prepend: site.url }}" alt="photo of {{person.name}}">
    <div>
